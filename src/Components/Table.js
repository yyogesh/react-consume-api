...
function createData(name, month, noOfTransactions, rewardPoints) {
    return {
        name,
        month,
        noOfTransactions,
...
const rows = [
    createData('Customer 1', 159, 6.0, 24, 4.0, 3.99),
    createData('Customer 2', 237, 9.0, 37, 4.3, 4.99),
    createData('Customer 3', 262, 16.0, 24, 6.0, 3.79),
    createData('Customer 4', 305, 3.7, 67, 4.3, 2.5),
    createData('Customer 5', 356, 16.0, 49, 3.9, 1.5),
];
